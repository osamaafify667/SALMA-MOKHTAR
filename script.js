// Preloader: never trap the visitor (slow networks, old webviews)
function hidePreloader(){ document.getElementById('preloader')?.classList.add('hide'); }
...
function setLang(l){
  ...
  if(btn) btn.textContent = l === 'en' ? 'AR' : 'EN';
...
try{
  ...
  if(saved === 'en' || saved === 'ar'){ setLang(saved); }
    ...
    // First visit: open in the visitor's device language
